...
/* TODO: replace the XMLHttpRequest with the fetch api. Keeping the xhr until fetch has better status events

// Source - https://stackoverflow.com/a/72930021
// Posted by Ricki-BumbleDev, modified by community. See post 'Timeline' for change history
...
//fileInput.addEventListener("change", () => {
  ...
  xhr.open("POST", "/import/"+route, true);
  xhr.send(fileData);
  /*
  fetch(importURL, {
